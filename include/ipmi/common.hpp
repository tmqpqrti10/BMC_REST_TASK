...
enum {
  PDPB_SENSOR_P12V = 0x30,
  PDPB_SENSOR_P3V3 = 0x31,
  PDPB_SENSOR_LEFT_REAR_TEMP = 0x32,
  PDPB_SENSOR_LEFT_FRONT_TEMP = 0x33,
  PDPB_SENSOR_RIGHT_REAR_TEMP = 0x34,
  PDPB_SENSOR_RIGHT_FRONT_TEMP = 0x35,
  PDPB_SENSOR_TEMP_CPU1_FRONT = 0x45,
  PDPB_SENSOR_TEMP_LEFT_REAR,
  PDPB_SENSOR_TEMP_NEAR_BMC,
  PDPB_SENSOR_TEMP_NEAR_CPU0,
  PDPB_SENSOR_TEMP_RIGHT_REAR,
  PDPB_SENSOR_TEMP_CPU1_FRONT2,
};
// Sensors under PEB
enum {
...
enum{
    ...
    NVA_SENSOR_BP_FAN1 = 0xA0,
    NVA_SENSOR_BP_FAN2 = 0xA1,
    NVA_SENSOR_BP_FAN3 = 0xA2,
    NVA_SENSOR_BP_FAN4 = 0xA3,
    NVA_SENSOR_BP_FAN5 = 0xA4,
    NVA_SENSOR_BP_FAN6 = 0xA5
};
