...
void rest_set_fru_product(int id, char f_name[LEN_NAME], char f_mfg[LEN_MFG],
                          char f_version[LEN_VERSION],
                          char f_serial[LEN_SERIAL],
                          char f_part_num[LEN_PART_NUM]);
void rest_set_fru_chassis(int id, char f_type, char f_serial[LEN_SERIAL],
                          char f_part_num[LEN_PART_NUM]);
