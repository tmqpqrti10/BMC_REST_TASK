...
class Ipmichassis
{
    ...
    public:
        ...
        void chassis_restart_cause(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_control(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_get_status(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_set_policy(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_identify(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_get_poh(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_set_boot_options(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
        void chassis_get_boot_options(ipmi_req_t *request, ipmi_res_t *response, uint8_t *res_len);
};
#endif