...
sensor_thresh_t peb_sensors[PEB_SENSOR_COUNT] = {
    ...
    0x00, 0x00, FRU_PEB, 0xC8, "P12V_PSU1"},
    ...
    P12V_VOUT_UNR_THRESHOLD, P12V_VOUT_UCR_THRESHOLD, P12V_VOUT_UNC_THRESHOLD,
    P12V_VOUT_LNR_THRESHOLD, P12V_VOUT_LCR_THRESHOLD, P12V_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xC8, "P12V_PSU2"},
    ...
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_VOLTS, 0x00, 0x00, (unsigned char) 17.19, M_TOLERANCE, 0x00, 0x0, 0x1, 0xD0, 0x0,
    ((unsigned char)(1000*5) / 17.19), 0xC5, 0x8B, 0xFF, 0x00,
    P3V3_VOUT_UNR_THRESHOLD, P3V3_VOUT_UCR_THRESHOLD, P3V3_VOUT_UNC_THRESHOLD,
    P3V3_VOUT_LNR_THRESHOLD, P3V3_VOUT_LCR_THRESHOLD, P3V3_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xC4, "P5V"},
    ...
    PVNN_VOUT_UNR_THRESHOLD, PVNN_VOUT_UCR_THRESHOLD, PVNN_VOUT_UNC_THRESHOLD,
    PVNN_VOUT_LNR_THRESHOLD, PVNN_VOUT_LCR_THRESHOLD, PVNN_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xC9, "P1V05_PCH"},
    ...
    0x00, 0x00, FRU_PEB, 0xC7, "BAT"},
    {BMC_SLAVE_ADDR, 0x00, PEB_SENSOR_NUM_BASE+8, 0x07, 0x0d, 0x7F, 0x68, SENSOR_TYPE_VOLTAGE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_VOLTS, 0x00, 0x00, (unsigned char) 1.8, M_TOLERANCE, 0x00, 0x0, 0x1, 0xD0, 0x0,
    ((unsigned char)(1000*0.8) / 1.8), 0xC5, 0x8B, 0xFF, 0x00,
    ...
    0x00, 0x00, FRU_PEB, 0xCB, "PVCCIN_IN"},
    ...
    ((unsigned char)(1000*0.8) / 9.40), 0xC5, 0x8B, 0xFF, 0x00,
    PVCCIN_VOUT_UNR_THRESHOLD, PVCCIN_VOUT_UCR_THRESHOLD, PVCCIN_VOUT_UNC_THRESHOLD,
    PVCCIN_VOUT_LNR_THRESHOLD, PVCCIN_VOUT_LCR_THRESHOLD, PVCCIN_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xCB, "PVNN_PCH_CPU0"},
    {BMC_SLAVE_ADDR, 0x00, PEB_SENSOR_NUM_BASE+10, 0x07, 0x0d, 0x7F, 0x68, SENSOR_TYPE_VOLTAGE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_VOLTS, 0x00, 0x00, (unsigned char) 9.40, M_TOLERANCE, 0x00, 0x0, 0x1, 0xD0, 0x0,
    ((unsigned char)(1000*1.8) / 9.40), 0xC5, 0x8B, 0xFF, 0x00,
    PVCCIN_VOUT_UNR_THRESHOLD, PVCCIN_VOUT_UCR_THRESHOLD, PVCCIN_VOUT_UNC_THRESHOLD,
    PVCCIN_VOUT_LNR_THRESHOLD, PVCCIN_VOUT_LCR_THRESHOLD, PVCCIN_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xCB, "P1V8_NACDELAY"},
    ...
    0x00, 0x00, FRU_PEB, 0xCE, "P1V2_VDDQ"},
    ...
    PVCCIN_VOUT_UNR_THRESHOLD, PVCCIN_VOUT_UCR_THRESHOLD, PVCCIN_VOUT_UNC_THRESHOLD,
    PVCCIN_VOUT_LNR_THRESHOLD, PVCCIN_VOUT_LCR_THRESHOLD, PVCCIN_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xCB, "PVNN_NAC"},
    ...
    PVNN_VOUT_UNR_THRESHOLD, PVNN_VOUT_UCR_THRESHOLD, PVNN_VOUT_UNC_THRESHOLD,
    PVNN_VOUT_LNR_THRESHOLD, PVNN_VOUT_LCR_THRESHOLD, PVNN_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xC9, "P1V05_NAC"},
    {BMC_SLAVE_ADDR, 0x00, PEB_SENSOR_NUM_BASE+14, 0x07, 0x0d, 0x7F, 0x68, SENSOR_TYPE_VOLTAGE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_VOLTS, 0x00, 0x00, (unsigned char) 7.06, M_TOLERANCE, 0x00, 0x0, 0x1, 0xD0, 0x0,
    ((unsigned char)(1000*2.5) / 7.06), 0xC5, 0x8B, 0xFF, 0x00,
    PVDDQ_VOUT_UNR_THRESHOLD, PVDDQ_VOUT_UCR_THRESHOLD, PVDDQ_VOUT_UNC_THRESHOLD,
    PVDDQ_VOUT_LNR_THRESHOLD, PVDDQ_VOUT_LCR_THRESHOLD, PVDDQ_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xCE, "PVPP"},
    {BMC_SLAVE_ADDR, 0x00, PEB_SENSOR_NUM_BASE+15, 0x07, 0x0d, 0x7F, 0x68, SENSOR_TYPE_VOLTAGE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_VOLTS, 0x00, 0x00, (unsigned char) 3.53, M_TOLERANCE, 0x00, 0x0, 0x1, 0xD0, 0x0,
    ((unsigned char)(1000*0.6) / 3.53), 0xC5, 0x8B, 0xFF, 0x00,
    PVDDQ_VOUT_UNR_THRESHOLD, PVDDQ_VOUT_UCR_THRESHOLD, PVDDQ_VOUT_UNC_THRESHOLD,
    PVDDQ_VOUT_LNR_THRESHOLD, PVDDQ_VOUT_LCR_THRESHOLD, PVDDQ_VOUT_LNC_THRESHOLD,
    0x00, 0x00, FRU_PEB, 0xCE, "PVTT"},
...
sensor_thresh_t nva_sensors[NVA_SENSOR_COUNT] = {
    ...
    {BMC_SLAVE_ADDR, 0x00, NVA_SYSTEM_FAN1, 0x1D, 0x0, 0x7F, 0x64, SENSOR_TYPE_FAN, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_RPM, 0x00, 0x00, 100, 0x01, 0x00, 0x02, 0x30, 0x00, 0x1,
    ...
    {BMC_SLAVE_ADDR, 0x00, NVA_SYSTEM_FAN2, 0x1D, 0x0, 0x7F, 0x64, SENSOR_TYPE_FAN, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_RPM, 0x00, 0x00, 100, 0x01, 0x00, 0x02, 0x30, 0x00, 0x1,
    ...
    {BMC_SLAVE_ADDR, 0x00, NVA_SYSTEM_FAN3, 0x1D, 0x0, 0x7F, 0x64, SENSOR_TYPE_FAN, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_RPM, 0x00, 0x00, 100, 0x01, 0x00, 0x02, 0x30, 0x00, 0x1,
    ...
    {BMC_SLAVE_ADDR, 0x00, NVA_SYSTEM_FAN4, 0x1D, 0x0, 0x7F, 0x64, SENSOR_TYPE_FAN, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_RPM, 0x00, 0x00, 100, 0x01, 0x00, 0x02, 0x30, 0x00, 0x1,
    ...
    {BMC_SLAVE_ADDR, 0x00, NVA_SYSTEM_FAN5, 0x1D, 0x0, 0x7F, 0x64, SENSOR_TYPE_FAN, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_RPM, 0x00, 0x00, 100, 0x01, 0x00, 0x02, 0x30, 0x00, 0x1,
...
sensor_thresh_t pdpb_sensors[PDPB_SENSOR_COUNT] = {
    ...
    0x00, 0x00, FRU_PDPB, 0xCF, "READ_RIGHT_TEMP"},
    {BMC_SLAVE_ADDR, 0x00, PDPB_SENSOR_TEMP_CPU_AMBIENT, 0x0A, 0x00, 0x7F, 0x64, SENSOR_TYPE_TEMPERATURE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_CELSIUS, 0x00, 0x00, 50, 0x00, 0x00, 0x0, 0x01, 0xE0, 0x01,
    ...
    PDPB_COMMON_UNR_THRESHOLD, PDPB_COMMON_UCR_THRESHOLD, PDPB_COMMON_UNC_THRESHOLD,
    PDPB_COMMON_LNR_THRESHOLD, PDPB_COMMON_LCR_THRESHOLD, PDPB_COMMON_LNC_THRESHOLD,
    0x00, 0x00, FRU_PDPB, 0xCE, "CPU_AMBIENT_TEMP"},
    {BMC_SLAVE_ADDR, 0x00, PDPB_SENSOR_TEMP_FRONT_RIGHT, 0x0A, 0x00, 0x7F, 0x64, SENSOR_TYPE_TEMPERATURE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_CELSIUS, 0x00, 0x00, 50, 0x00, 0x00, 0x0, 0x01, 0xE0, 0x01,
    ...
    PDPB_COMMON_UNR_THRESHOLD, PDPB_COMMON_UCR_THRESHOLD, PDPB_COMMON_UNC_THRESHOLD,
    PDPB_COMMON_LNR_THRESHOLD, PDPB_COMMON_LCR_THRESHOLD, PDPB_COMMON_LNC_THRESHOLD,
    0x00, 0x00, FRU_PDPB, 0xCC, "FRONT_RIGHT_TEMP"},
    {BMC_SLAVE_ADDR, 0x00, PDPB_SENSOR_TEMP_PCIE_AMBIENT, 0x0A, 0x00, 0x7F, 0x64, SENSOR_TYPE_TEMPERATURE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_CELSIUS, 0x00, 0x00, 50, 0x00, 0x00, 0x0, 0x01, 0xE0, 0x01,
    ...
    PDPB_COMMON_UNR_THRESHOLD, PDPB_COMMON_UCR_THRESHOLD, PDPB_COMMON_UNC_THRESHOLD,
    PDPB_COMMON_LNR_THRESHOLD, PDPB_COMMON_LCR_THRESHOLD, PDPB_COMMON_LNC_THRESHOLD,
    0x00, 0x00, FRU_PDPB, 0xCE, "PCIE_AMBIENT_TEMP"},
    {BMC_SLAVE_ADDR, 0x00, PDPB_SENSOR_TEMP_FRONT_LEFT, 0x0A, 0x00, 0x7F, 0x64, SENSOR_TYPE_TEMPERATURE, SENSOR_EVENT_READING_THRESHOLD,
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_EVENT_ASSERTION_LS, SENSOR_EVENT_ASSERTION_MS},
    {SENSOR_MASK_READ_SETTABLE_LS, SENSOR_MASK_READ_SETTABLE_MS},
    0x00, SENSOR_UNIT_CELSIUS, 0x00, 0x00, 50, 0x00, 0x00, 0x0, 0x01, 0xE0, 0x01,
