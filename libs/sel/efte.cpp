...
struct bit_desc_map severity_name = {
	{
		{"Unspecified", 0x00},
		{"Monitor", 0x01},
		{"Information", 0x02},
...
struct bit_desc_map voltage_sensor_name = {
	{
		{"PEB_ADC_P12V", PEB_SENSOR_ADC_P12V},
		{"PEB_ADC_P3V3_AUX", PEB_SENSOR_ADC_P3V3_AUX},	
		{"PEB_ADC_P1V0_STBY", PEB_SENSOR_ADC_P1V0_STBY},
		{"PEB_ADC_P1V05_PCH_AUX", PEB_SENSOR_ADC_P1V05_PCH_AUX},
		{"PEB_ADC_P12V_AUX", PEB_SENSOR_ADC_P12V_AUX},
		{"PEB_ADC_P1V8_PCH_AUX", PEB_SENSOR_ADC_P1V8_PCH_AUX},
		{"PEB_ADC_P3V0_BAT", PEB_SENSOR_ADC_P3V0_BAT},
		{"PEB_ADC_P1V7_CPU0", PEB_SENSOR_ADC_P1V7_CPU0},
		{"PEB_ADC_P1V7_CPU1", PEB_SENSOR_ADC_P1V7_CPU1},
		{"PEB_ADC_P1V2_ABC", PEB_SENSOR_ADC_P1V2_ABC},
		{"PEB_ADC_P1V2_DEF", PEB_SENSOR_ADC_P1V2_DEF},
		{"PEB_ADC_P1V2_GHJ", PEB_SENSOR_ADC_P1V2_GHJ},
		{"PEB_ADC_P1V2_KLM", PEB_SENSOR_ADC_P1V2_KLM},
		{"PEB_ADC_P1V0_CPU0", PEB_SENSOR_ADC_P1V0_CPU0},
		{"PEB_ADC_P1V0_CPU1", PEB_SENSOR_ADC_P1V0_CPU1},
		{NULL}
	}
};
...
struct bit_desc_map temperature_sensor_name = {
	{
		{"CPU1_FRONT_TEMP", PDPB_SENSOR_TEMP_CPU1_FRONT},
		{"LEFT_REAR_TEMP", PDPB_SENSOR_TEMP_LEFT_REAR},
		{"NEAR_BMC_TEMP", PDPB_SENSOR_TEMP_NEAR_BMC},
		{"NEAR_CPU0_TEMP", PDPB_SENSOR_TEMP_NEAR_CPU0},
		{"RIGHT_REAR_TEMP", PDPB_SENSOR_TEMP_RIGHT_REAR},
...
struct bit_desc_map fan_sensor_name = {
	{
		...
		{"FANTACH_1", NVA_SENSOR_BP_FAN1},
		{"FANTACH_2", NVA_SENSOR_BP_FAN2},
		{"FANTACH_3", NVA_SENSOR_BP_FAN3},
		{"FANTACH_4", NVA_SENSOR_BP_FAN4},
		{"FANTACH_5", NVA_SENSOR_BP_FAN5},
		{"FANTACH_6", NVA_SENSOR_BP_FAN6},
		{NULL}
	}
};
...
int set_eft_init(void){
	...
	pef_table_entry_t pef_init_table[pef_eft_table_size] = {
		{PEF_FILTER_DISABLED,EVENT_FILTER_ACTION_ALERT,PEF_POLICY_NUMBER_DONT_CARE, EVENT_SEVERITY_UNSPECIFIED,
		0x02,0x00,0x01, 0x24,PEF_EVENT_TRIGGER_THRESHOLD,0x95,0x0a,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00},

		{PEF_FILTER_DISABLED,EVENT_FILTER_ACTION_ALERT,PEF_POLICY_NUMBER_DONT_CARE, EVENT_SEVERITY_UNSPECIFIED,
		0x02,0x00,0x02, NVA_SENSOR_PSU1_WATT,PEF_EVENT_TRIGGER_THRESHOLD,0x95,0x0a,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00},

		{PEF_FILTER_DISABLED,EVENT_FILTER_ACTION_ALERT,PEF_POLICY_NUMBER_DONT_CARE, EVENT_SEVERITY_UNSPECIFIED,
		0x02,0x00,0x04, PDPB_SENSOR_TEMP_CPU0,PEF_EVENT_TRIGGER_THRESHOLD,0x95,0x0a,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00},

		{PEF_FILTER_DISABLED,EVENT_FILTER_ACTION_ALERT,PEF_POLICY_NUMBER_DONT_CARE, EVENT_SEVERITY_UNSPECIFIED,
		0x02,0x00,0x08, NVA_SENSOR_PSU1_TEMP,PEF_EVENT_TRIGGER_SENSOR_SPECIFIC,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00},
	};
	...
	if(access(EVENT_FILTER_TABLE_FILE, F_OK) < 0){
		...
		pef_act_glb_ctrl = EVENT_FILTER_ACTION_ALERT | EVENT_FILTER_ACTION_POWER_OFF \
		...
		for(j=0; j<temp; j++){
			...
			temp_pef_data[j+dp].sensor_number = temperature_sensor_name.list[j].mask;
			set_eft_entry(index[j+dp], (unsigned char *)&temp_pef_data[j+dp]);
		}
...
//			strncpy(msg, temperature_sensor_name.list[sensor_index].desc, namelen);
...
//			strncpy(msg, voltage_sensor_name.list[sensor_index].desc, namelen);
...
//			strncpy(msg, current_sensor_name.list[sensor_index].desc, namelen);
...
//			strncpy(msg, fan_sensor_name.list[sensor_index].desc, namelen);
...
void
pef_get_config_param (ipmi_req_t *request,
		ipmi_res_t *response, unsigned char *res_len)
{
...
void
pef_set_config_param (ipmi_req_t *request,
		ipmi_res_t *response, unsigned char *res_len)
{
	ipmi_req_t *req = (ipmi_req_t *) request;
	ipmi_res_t *res= (ipmi_res_t *) response;
...
void
pef_capabilities_info (ipmi_res_t *response, unsigned char *res_len)
{
	ipmi_res_t *res= (ipmi_res_t *) response;
	unsigned char *data = &res->data[0];
	unsigned char tmp;
